 ...
 *         @ORM\Table(name="sej_colgroups")
 *         @ORM\Entity(repositoryClass="Samenjoy\DataBundle\Repository\ColGroupRepository")
...
class ColGroup
{
	 ...
	 * @ORM\SequenceGenerator(sequenceName="sej_colgroups_id_seq", allocationSize=1, initialValue=1)
	 */
	protected $id;
	...
	/**
	 * @var Collection @ORM\OneToMany(targetEntity="ColGroupTrans", mappedBy="group", cascade={"persist", "remove"})
	 *      @ORM\OrderBy({"dtCrea" = "DESC"})
	 */
	protected $translations;

	/**
	 * @var Collection @ORM\OneToMany(targetEntity="ProdGroup", mappedBy="group", cascade={"persist", "remove"})
	 *      @ORM\OrderBy({"dtCrea" = "DESC"})
	 */
	...
	/**
	 * @param ColGroupTrans $translation
	 *
	 * @return ColGroup
	 */
	public function addTranslation(ColGroupTrans $translation)
	{
	 ...
	 * @return ColGroup
	 */
	public function removeTranslation(ColGroupTrans $translation)
	{
