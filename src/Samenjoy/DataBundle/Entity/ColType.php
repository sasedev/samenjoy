 ...
 *         @ORM\Table(name="sej_coltypes")
 *         @ORM\Entity(repositoryClass="Samenjoy\DataBundle\Repository\ColTypeRepository")
...
class ColType
{
     ...
     * @ORM\SequenceGenerator(sequenceName="sej_coltypes_id_seq", allocationSize=1, initialValue=1)
     */
    protected $id;
    ...
    /**
     * @var Collection @ORM\OneToMany(targetEntity="ColTypeTrans", mappedBy="type", cascade={"persist", "remove"})
     *      @ORM\OrderBy({"dtCrea" = "DESC"})
     */
    protected $translations;

    /**
     * @var Collection @ORM\OneToMany(targetEntity="ProdGroup", mappedBy="type", cascade={"persist", "remove"})
     *      @ORM\OrderBy({"dtCrea" = "DESC"})
     */
    ...
    /**
     * @param ColTypeTrans $translation
     *
     * @return ColType
     */
    public function addTranslation(ColTypeTrans $translation)
    {
     ...
     * @return ColType
     */
    public function removeTranslation(ColTypeTrans $translation)
    {
